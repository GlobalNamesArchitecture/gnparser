...
2. run it with Spark by executing ``$SPARK_HOME/bin/spark-submit ./examples/spark/target/scala-2.10/gnparser-example-spark-assembly-0.4.4.jar``
...
.. code:: bash
    ...
    $SPARK_HOME/bin/pyspark \
      --jars "`pwd`/spark-python/target/scala-2.10/gnparser-spark-python-assembly-0.4.4.jar" \
      --driver-class-path="`pwd`/spark-python/target/scala-2.10/gnparser-spark-python-assembly-0.4.4.jar"`
